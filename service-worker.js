...
const SHELL_CACHE = `${CACHE_VERSION}-anomaly-v1-globe-failsafe-v2-shell-readable-attention-v1`;
...
const APP_SHELL = [
  ...
  './src/world/earthquake-anomaly-presentation.js',
  './src/world/earthquake-live-data.js',
  './src/world/live-marker-render-gate.js',
  './src/world/earthquake-depth-presentation.js',
  ...
  './src/world/earthquake-forecast/thermal-data.js',
  './src/world/earthquake-forecast/depth-migration-types.js',
  './src/world/earthquake-forecast/depth-migration.js',
  './src/world/earthquake-forecast/thermal-observation-quality.js',
  './src/world/earthquake-forecast/thermal-source-exclusions.js',
  './src/world/earthquake-forecast/surface-temperature-adapter.js',
  './src/world/earthquake-forecast/thermal-transfer-hypothesis.js',
  './src/world/earthquake-forecast/prediction-schema.js',
  './src/world/earthquake-forecast/prediction-ledger.js',
  './src/world/earthquake-forecast/prediction-evaluation.js',
  './src/world/earthquake-forecast/research-validation-presenter.js',
  './src/world/earthquake-forecast/research-validation-ui.js',
  ...
  './src/world/prediction-engine/thermal.js',
  './src/world/prediction-engine/power-thermal.js',
