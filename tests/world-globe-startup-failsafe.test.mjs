...
assert.match(app,/globe-failsafe-v1/,'clients must fetch a new World module generation');
assert.match(worker,/globe-failsafe-v1-shell/,'the offline shell must receive a new cache generation');
