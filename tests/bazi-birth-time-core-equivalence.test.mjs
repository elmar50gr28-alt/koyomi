...
assert.equal(missingLongitude.trueSolarTime.minutesOffset, 0, '経度なしでは入力時刻を動かさないこと');
assert.equal(missingLongitude.trueSolarTime.warning, 'longitude-missing', '経度なしを警告すること');
