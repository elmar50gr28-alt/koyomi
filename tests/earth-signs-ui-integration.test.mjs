...
for(const token of ['world-map-ranking-panel','bindExclusiveRanking','<details ${wasOpen','ranking.querySelector(\'details\').open=false'])assert.ok(ui.includes(token),`${token} must keep rankings collapsed and mutually exclusive`);
